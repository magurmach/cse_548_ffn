...
# Import dataset.
# Dataset is given in file_name variable You can replace it with the file 
...
X_train, y_train = get_dataset(TrainingDataPath+TrainingData)
X_test, y_test = get_dataset(TestDataPath+TestData)
